...
class AdvertisersControllerTest < ActionController::TestCase
  ...
  test "should create advertiser" do
    assert_difference('Advertiser.count') do
      post :create, advertiser: { address: @advertiser.address, category: @advertiser.category, is_member: @advertiser.is_member, name: @advertiser.name, phone: @advertiser.phone, pincode: @advertiser.pincode, wants_calls: @advertiser.wants_calls }
    end
  ...
  test "should update advertiser" do
    patch :update, id: @advertiser, advertiser: { address: @advertiser.address, category: @advertiser.category, is_member: @advertiser.is_member, name: @advertiser.name, phone: @advertiser.phone, pincode: @advertiser.pincode, wants_calls: @advertiser.wants_calls }
    assert_redirected_to advertiser_path(assigns(:advertiser))
  end
